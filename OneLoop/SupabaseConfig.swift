...
enum SupabaseConfig {
    ...
    /// `oneloop://auth-callback…` so ASWebAuthenticationSession can close.
    ///
    ...
    static let authCallbackScheme = "oneloop"

    /// Final deep link prefix used by the bridge page and onOpenURL.
    static let authCallbackURL = URL(string: "oneloop://auth-callback")!
